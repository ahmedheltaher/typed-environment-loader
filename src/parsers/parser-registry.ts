...
interface TypedParserContext<Type extends SchemaItem> extends ParserContext {
	schema: Type;
}

interface TypedParserResult<Type> extends ParserResult {
	value: Type;
}

interface TypedParser<Type extends SchemaItem, Registry> {
...
export class ParserRegistry {
	...
	register<Type extends SchemaItem, R>(type: string, parserClass: ParserConstructor<Type, R>): this {
	...
	parse<Type = unknown>(context: ParserContext): TypedParserResult<Type> {
		...
		const result = parser.parse(context) as TypedParserResult<Type>;
